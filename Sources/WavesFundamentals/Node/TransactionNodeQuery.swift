...
public extension NodeService.Query.Transaction {
    ...
    struct Sponsorship: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_1.rawValue, chainId: Int, fee: Int64, timestamp: Int64 = 0, senderPublicKey: String = "", proofs: [String] = [], minSponsoredAssetFee: Int64?, assetId: String) {
    ...
    struct SetAssetScript: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_1.rawValue, chainId: Int, fee: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = [], script: String?, assetId: String) {
    ...
    struct SetScript: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_1.rawValue, chainId: Int, fee: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = [], script: String?) {
    ...
    struct MassTransfer: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_1.rawValue, chainId: Int, fee: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = [], assetId: String, attachment: String, transfers: [Transfer]) {
    ...
    struct Reissue: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_2.rawValue, chainId: Int, fee: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = [], assetId: String, quantity: Int64, isReissuable: Bool) {
            self.version = version
    ...
    struct InvokeScript: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public struct Arg: Encodable, Decodable {
            public enum Value: Encodable, Decodable {
                ...
                public init(from decoder: Decoder) throws {
                    ...
                    if let value = try? values.decode([NodeService.Query.Transaction.InvokeScript.Arg].self, forKey: .list) {
                        self = .list(value)
                        return
                    }
        ...
        public init(version: Int = TransactionVersion.version_1.rawValue, chainId: Int, fee: Int64, timestamp: Int64 = 0,
    ...
    struct Burn: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_2.rawValue, chainId: Int, fee: Int64, assetId: String, quantity: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = []) {
            self.version = version
    ...
    struct Alias: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_2.rawValue, chainId: Int, name: String, fee: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = []) {
            self.chainId = chainId
            self.version = version
            self.name = name
            self.fee = fee
    ...
    struct Lease: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_2.rawValue, chainId: Int, fee: Int64, recipient: String, amount: Int64, timestamp: Int64, senderPublicKey: String, proofs: [String] = []) {
            self.version = version
            self.chainId = chainId
            self.fee = fee
            self.recipient = recipient
    ...
    struct LeaseCancel: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_2.rawValue, chainId: Int, fee: Int64, leaseId: String, timestamp: Int64, senderPublicKey: String, proofs: [String] = []) {
            self.version = version
            self.chainId = chainId
            self.fee = fee
    ...
    struct Data: BaseTransactionQueryProtocol, Encodable, Decodable {
        ...
        public init(version: Int = TransactionVersion.version_1.rawValue, fee: Int64, timestamp: Int64 = 0, senderPublicKey: String = "", proofs: [String] = [], data: [Value], chainId: Int) {
    ...
    struct Transfer: BaseTransactionQueryProtocol, Decodable, Encodable {
        ...
        public init(version: Int = TransactionVersion.version_2.rawValue, recipient: String, assetId: String, amount: Int64, fee: Int64, attachment: String, feeAssetId: String, timestamp: Int64 = 0, senderPublicKey: String = "", proofs: [String] = [], chainId: Int) {
